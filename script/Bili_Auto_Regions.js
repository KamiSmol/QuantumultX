...
#可选, 适用于搜索指定地区的番剧
^https:\/\/ap(p|i)\.bili(bili|api)\.(com|net)\/x\/v\d\/search(\/type)?\?.+?%20(%E6%B8%AF|%E5%8F%B0|%E4%B8%AD|%E7%95%AA%E5%89%A7%E5%87%BA%E5%B7%AE)& url script-request-header https://raw.githubusercontent.com/NobyDa/Script/master/Surge/JS/Bili_Auto_Regions.js
...
async function SwitchRegion(play) {
	...
	const area = (() => {
		let select;
		if (/\u50c5[\u4e00-\u9fa5]+\u6e2f|%20%E6%B8%AF&|%E7%95%AA%E5%89%A7%E5%87%BA%E5%B7%AE/.test(play)) {
